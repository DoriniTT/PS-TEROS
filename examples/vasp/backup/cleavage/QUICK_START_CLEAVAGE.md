...
A new module `psteros.core.cleavage` that calculates cleavage energies for complementary slab pairs generated by pymatgen's SlabGenerator.
...
### New Files:
1. `psteros/core/cleavage.py` - Main cleavage energy module
2. `docs/cleavage_energy.md` - Detailed documentation
3. `CLEAVAGE_IMPLEMENTATION.md` - Implementation details

### Modified Files:
1. `psteros/core/workgraph.py` - Added cleavage energy support
2. `psteros/core/__init__.py` - Added cleavage exports

...
def main():
    ...
    print("\n4. Building workflow with preset + overrides...")
    ...
    print("     [x] compute_cleavage: True (OVERRIDE)")
    print("     [x] compute_relaxation_energy: True (OVERRIDE)")
    ...
    wg = build_core_workgraph(
        ...
        name=f'Step11_PresetWithOverrides_Ag2O_{miller_indices[0]}{miller_indices[1]}{miller_indices[2]}',
    )

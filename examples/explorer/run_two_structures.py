...
structures = {
    'structure_1': orm.StructureData(ase=read(script_dir / 'structure_1.vasp')),
    'structure_2': orm.StructureData(ase=read(script_dir / 'structure_2.vasp')),
}

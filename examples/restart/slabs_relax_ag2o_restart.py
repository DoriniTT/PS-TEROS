...
This script demonstrates the binary oxide workflow (Ag2O):
...
6. Access the relaxed slab structures, energies, and thermodynamics

Example: Ag2O (100) surface with full slab relaxation and thermodynamics
    ...
    - Outputs relaxed slabs, energies, and thermodynamics data

Usage:
    source ~/envs/psteros/bin/activate && python slabs_relax_ag2o.py
"""

...
from teros.core.lego.bricks.aimd import (  # noqa: E402
...
from teros.core.lego.tasks import (  # noqa: E402
...
class TestAimdImportAndBasic:
    ...
    def test_aimd_brick_importable(self):
        ...
        from teros.core.lego.bricks import aimd
    ...
    def test_aimd_ports_defined(self):
        ...
        from teros.core.lego.bricks.aimd import PORTS

...
from teros.core.lego.tasks import extract_energy, compute_dynamics  # noqa: E402
from teros.core.lego.tasks import prepare_poscar_with_velocities  # noqa: E402
...
class TestVaspRelaxResultExtraction:
    ...
    def test_get_energy_matches_get_results(self, reference_pks):
        ...
        from tests.conftest import load_node_or_skip
        from teros.core.lego.results import get_results, get_energy

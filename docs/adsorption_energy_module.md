...
The adsorption energy module (`psteros.core.adsorption_energy`) provides tools to calculate adsorption energies from substrate+adsorbate structures using AiiDA-WorkGraph and VASP. The module uses advanced connectivity analysis to automatically separate structures and performs parallel DFT calculations to obtain adsorption energies.
...
from psteros.experimental.adsorption_energy.lamno3.add_ooh_to_surface import main as add_ooh
...
# Load structure
from psteros.core import get_structure_from_file
...
from psteros.core import compute_adsorption_energies_scatter, get_structure_from_file
...
- **Tests**: `psteros/core/test_adsorption_energy.py`

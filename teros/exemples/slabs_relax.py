...
def main():
    ...
    structures_dir = "/home/thiagotd/git/PS-TEROS/teros/exemples/structures"
    ...
    wg = build_core_workgraph_with_map(
        ...
        bulk_name="bulk/Ag6O8P2_optimized.cif",
        metal_name="pure_elements/Ag.cif",
        nonmetal_name="pure_elements/P.cif",
        oxygen_name="pure_elements/O2.cif",

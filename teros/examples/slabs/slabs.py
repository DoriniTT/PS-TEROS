...
def main():
    ...
    lll_reduce = False      # Apply LLL reduction to get more orthogonal cell
    center_slab = True      # Center slab in the c direction
    symmetrize = False      # Generate all unique terminations (False) or only symmetric ones (True)
    ...
    print(f"  4. Generates all slab terminations for ({miller_indices[0]}{miller_indices[1]}{miller_indices[2]}) orientation")

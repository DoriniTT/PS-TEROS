...
from .lego import (
    ...
    quick_vasp_batch,
    quick_dos,
    get_results as get_explorer_results,
    get_energy as get_explorer_energy,
    get_batch_results as get_explorer_batch_results,
    get_batch_energies as get_explorer_batch_energies,
    get_batch_results_from_workgraph,
    print_results as print_explorer_results,
    get_status as get_explorer_status,
    get_dos_results,
    print_dos_results,
    export_files,
    list_calculations,
...
__all__ = [
    ...
    "quick_vasp_batch",
    "quick_dos",
    "get_explorer_results",
    "get_explorer_energy",
    "get_explorer_batch_results",
    "get_explorer_batch_energies",
    "get_batch_results_from_workgraph",
    "print_explorer_results",
    "get_explorer_status",
    "get_dos_results",
    "print_dos_results",
    "export_files",

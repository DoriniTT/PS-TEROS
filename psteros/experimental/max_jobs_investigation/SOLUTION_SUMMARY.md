...
1. `relax_slabs_scatter` in `psteros/core/slabs.py`
2. `scf_slabs_scatter` in `psteros/core/slabs.py`
3. `compute_surface_energies_scatter` in `psteros/core/surface_energy.py`
4. `scf_relax_and_calculate_relaxation_energy` in `psteros/core/slabs.py`

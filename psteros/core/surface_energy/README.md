...
> For non-stoichiometric or asymmetric surfaces, use `psteros.core.thermodynamics` instead.
...
> **Note**: For non-stoichiometric or asymmetric surfaces, use `psteros.core.thermodynamics`
...
```python
from psteros.core.surface_energy import find_stoichiometric_symmetric_slabs
...
```python
from psteros.core.surface_energy import analyze_miller_feasibility, get_feasibility_summary
...
```python
from psteros.core.surface_energy import build_wulff_shape
...
Use the thermodynamics module (`psteros.core.thermodynamics`) when:
...
- `psteros.core.thermodynamics` - Oxide surface thermodynamics with chemical potentials
- `psteros.core.slabs` - Slab generation utilities

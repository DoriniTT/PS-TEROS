...
from psteros.core.surface_energy.surface_energy import (
    calculate_metal_surface_energy,
    calculate_bulk_energy_per_atom,
)
from psteros.core.surface_energy.wulff import build_wulff_shape
from psteros.core.surface_energy.stoichiometric_finder import (
...
def build_metal_surface_energy_workgraph(
    ...
    Args:
        ...
        require_stoichiometric_symmetric: If True (default), use stoichiometric+symmetric
            ...
            For non-stoichiometric surfaces, use psteros.core.thermodynamics instead.

...
def test_get_formula_dict(ag3po4_bulk):
    ...
    from psteros.core.surface_hydroxylation.surface_energy import _get_formula_dict
...
def test_analyze_composition_pristine(ag3po4_bulk, ag3po4_slab_pristine):
    ...
    from psteros.core.surface_hydroxylation.surface_energy import analyze_composition
...
def test_calc_delta_g_reaction1(expected_values):
    ...
    from psteros.core.surface_hydroxylation.surface_energy import calc_delta_g_reaction1
...
def test_calc_delta_g_reaction2():
    ...
    from psteros.core.surface_hydroxylation.surface_energy import calc_delta_g_reaction2
...
def test_calc_delta_g_reaction3():
    ...
    from psteros.core.surface_hydroxylation.surface_energy import calc_delta_g_reaction3
...
def test_select_reaction_function():
    ...
    from psteros.core.surface_hydroxylation.surface_energy import (
...
def test_get_surface_area(ag3po4_slab_pristine):
    ...
    from psteros.core.surface_hydroxylation.surface_energy import get_surface_area
...
def test_calc_gamma_s(expected_values):
    ...
    from psteros.core.surface_hydroxylation.surface_energy import calc_gamma_s
...
def test_calc_gamma(expected_values):
    ...
    from psteros.core.surface_hydroxylation.surface_energy import calc_gamma
...
def test_calculate_surface_energies_full_workflow(
    ...
    from psteros.core.surface_hydroxylation.surface_energy import calculate_surface_energies

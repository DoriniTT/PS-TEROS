...
```bash
pytest psteros/core/aimd/test_utils.py -v      # Validation and merging utilities
pytest psteros/core/aimd/test_tasks.py -v      # Supercell creation
pytest psteros/core/aimd/test_overrides.py -v  # Override system and priority
```
...
This module is **independent** from `psteros.core.workgraph.build_core_workgraph()` but reuses the underlying `aimd_single_stage_scatter()` function from `psteros.core.aimd_functions`.

...
Successfully created a new `psteros.default_builders` module that stores default VASP calculation parameters for specific material systems. The module reduces boilerplate code by **~49%** while maintaining full flexibility.

## Files Created

### 1. Core Module
- **`psteros/default_builders.py`** (325 lines, 9.9KB)
...
To add new materials, use the template in `psteros/default_builders.py`:
...
**Created**: 2025-01-09
**Module**: `psteros.default_builders`

...
A new module `psteros.default_builders` has been created to store default VASP calculation parameters for specific material systems, reducing boilerplate code and improving maintainability.

## What Was Created

### 1. Core Module
**File**: `psteros/default_builders.py`
...
To add new materials, follow the template in `psteros/default_builders.py`:

...
- **Wrapper script**: `psteros/core/fukui/scripts/fukui_interpolation_wrapper.py`
- **FukuiGrid location**: `psteros/external/FukuiGrid/` (cloned, gitignored)
...
```python
from psteros.core.fukui import build_fukui_workgraph, run_fukui_interpolation
...
- **Wrapper script**: `psteros/core/fukui/scripts/fukui_electrodes_wrapper.py`
...
- **Wrapper script**: `psteros/core/fukui/scripts/perturbative_expansion_wrapper.py`

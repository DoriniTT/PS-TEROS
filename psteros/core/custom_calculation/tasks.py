...
@task.calcfunction
def extract_total_energy(misc: orm.Dict, retrieved: orm.FolderData = None) -> orm.Float:
    """
    ...
    raise ValueError(f'Unable to find total energy in misc output or OUTCAR. Available keys in misc: {available}')

...
.. code-block:: python
    ...
    from psteros.core.stages import StageContext, resolve_workflow_preset
...
from psteros.core.stages.preset_resolution import resolve_workflow_preset


# Stage 2: Input validation - implemented in input_validation.py
from psteros.core.stages.input_validation import (
    validate_workflow_inputs,
    log_workflow_configuration,
)
...
def setup_cp2k_files(*args, **kwargs):
    ...
    raise NotImplementedError(
        ...
        "Import from psteros.core.stages.cp2k_setup when available."
    )
...
def build_core_workgraph_base(*args, **kwargs):
    ...
    raise NotImplementedError(
        ...
        "Import from psteros.core.stages.core_build when available."
    )
...
def resolve_slab_parameters(*args, **kwargs):
    ...
    raise NotImplementedError(
        ...
        "Import from psteros.core.stages.input_slabs when available."
    )

...
Usage:
    # Apply all patches
    from psteros.core.vasp_parallelization.patches import apply_all_patches
    apply_all_patches()

    # Or run from command line
    python -m psteros.core.vasp_parallelization.patches.apply_patches

    # Verify patches are applied
    from psteros.core.vasp_parallelization.patches import verify_patches
    verify_patches()
"""
